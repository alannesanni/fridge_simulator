...
def home():
    ...
    if recipes:
        return render_template("home.html", ing_names_fridge=ing_names_fridge,
                               ing_names_pantry=ing_names_pantry, recipes=recipes,
                               liked_rec=liked_rec, liked_count=liked_count)
    return render_template("home.html", ing_names_fridge=ing_names_fridge,
                           ing_names_pantry=ing_names_pantry, recipes=None,
                           liked_rec=liked_rec, liked_count=liked_count)
...
def recipe(recipe_name):
    ...
    return render_template("recipe.html", recipe_name=recipe_tuple[0],
                           recipe_ingredients=recipe_tuple[1], recipe_instructions=recipe_tuple[2],
                           length_ing=length_ing, is_liked=is_liked, likes=likes)
